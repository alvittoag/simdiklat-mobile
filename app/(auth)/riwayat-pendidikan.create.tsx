  ...
  const mutationAdd = useMutation({
    mutationFn: async (formData: FormData) => {
      return await axiosService.post(
        "/api/data-kompetensi/riwayat-pendidikan/post",
        formData,
        {
          headers: {
    ...
    onSuccess: () => {
      Dialog.show({
        ...
        title: "Berhasil",
        textBody: "Riwayat Pendidikan Berhasil Ditambahkan",
        button: "Tutup",
      });
      setDataInput({
        name_sekolah: "",
    ...
    onError: (error) => {
      console.error("Error adding riwayat pendidikan:", error);
      Dialog.show({
        type: ALERT_TYPE.DANGER,
        title: "Gagal",
        textBody: error?.message || "Riwayat Pendidikan Gagal Ditambahkan",
        button: "Tutup",
      });
    },
  });
